...
import { saveTournamentAsync, deleteTournamentAsync } from "@/features/tournaments/storage";
import { loadTournamentFromCloud } from "@/features/tournaments/services/cloud-sync";
...
const DashboardTab = dynamic(() => import("../_components/dashboard-tab").then(mod => ({ default: mod.DashboardTab })), {
  loading: () => <div className="text-center py-8">Loading...</div>,
});

const PlayersTab = dynamic(() => import("../_components/players-tab").then(mod => ({ default: mod.PlayersTab })), {
  loading: () => <div className="text-center py-8">Loading...</div>,
});

const RoundsTab = dynamic(() => import("../_components/rounds-tab").then(mod => ({ default: mod.RoundsTab })), {
  loading: () => <div className="text-center py-8">Loading...</div>,
});

const SettingsTab = dynamic(() => import("../_components/settings-tab").then(mod => ({ default: mod.SettingsTab })), {
  loading: () => <div className="text-center py-8">Loading...</div>,
});
